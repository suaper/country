<template>
  <q-page class="flex flex-center view_hijos_socios view_fitness">
    <Menucultura currentItem="/cultura/multimedia"/>
                ...
                <q-carousel-slide class="column no-wrap" :name="key" v-for="(item, key) in slidersContentImages" :key="key">
                    <div class="row fit justify-between items-center q-gutter-xs q-col-gutter no-wrap">
                        <table class="item_cien">
                            ...
                            <tr>
                                <td class="othet">
                                    <img :src="(typeof item[2] !== 'undefined') ? urlSite + item[2].field_portada_multimedia : urlSite + item[1].field_portada_multimedia" />
                                    <div class="info_bottom text-center">
                                        <p class="desc">{{ (typeof item[2] !== 'undefined') ? item[2].title : item[1].title }}</p>
                                        <span v-html="(typeof item[2] !== 'undefined') ? item[2].body : item[1].body"></span>
                                    </div>
                                </td>
                            </tr>
                        </table>
