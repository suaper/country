  ...
  <q-page class="flex flex-center view_hijos_socios">
    ...
    <div class="q-pb-md all_width gris_home">
        <div class="cincuenta q-pd-md centrar text-center">
            ...
            <p class="intro text-center">Familias deportiva del PWCC con uno más miembros activos de Rama.</p>
        </div>
    </div>
    ...
    <div class="q-pb-md all_width bg_amarillo wrp_club hazte_socio">
        <div class="centrar w_1200">
            <h4 class="subtitle">Requisitos</h4>
                <p class="intro text-left">Si uno o más miembros de tu familia participa activamente en la rama de Hockey, Rugby o Fútbol, hace tres años o más, estás al día en los pagos de la rama y compartes los valores deportivos del Club, esta categoría es para tu familia.</p>

                <p class="intro text-left">Hemos abierto cupos limitados, bajo condiciones especiales de incorporación, para familias que formen parte de alguna de estas ramas deportivas, que proyecten una vida familiar vinculada al deporte PWCC y que encarnen valores fundamentales para el Country Club, como son el fair play y la promoción de un ambiente de respeto. </p>

                <p class="intro text-left">Para más información, contáctanos vía email a socios@pwcc.cl</p>
        </div>
    </div>
    ...
    <div class="q-pb-md all_width gris_home wrp_club hazte_socio">
        <div class="centrar w_1200">
            ...
            <p class="intro text-left">El monto de la cuota trimestral depende de la edad y estado civil del postulante.</p>
