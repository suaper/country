  ...
  <q-page class="flex flex-center view_hijos_socios">
    ...
    <div class="q-pb-md all_width gris_home">
        <div class="cincuenta q-pd-md centrar text-center">
            <div class="center text-center q-my-lg titulos">Hijos de Socios</div>
            <p class="intro text-center">Hijos de socios activos del Club que tengan <strong>más de 24 años.</strong> </p>
        </div>
    </div>
    ...
    <div class="q-pb-md all_width bg_amarillo wrp_club hazte_socio">
        <div class="centrar w_1200">
            ...
            <p class="intro text-left">Todos los hijos de socios activos antes de cumplir 25 años deben acercarse al Club y comenzar su proceso de incorporación, esto incluye a aquellos que tengan su Cuota de Incorporación previamente pagada.</p>
        </div>
    </div>
