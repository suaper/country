<template>
  <q-page class="flex flex-center view_hijos_socios">
    <Menuhaztesocio currentItem="/hazte-socio/hijos-socios"/>
    ...
    <div class="q-py-md all_width bg_amarillo wrp_club">
        <div class="q-py-md centrar text-center w_1200">
            <q-btn outline @click="irFormulario('hijo-socio')" class="text_white  centrar bg_orange btn_centrar" label="Postule Aquí" icon-right="arrow_right_alt"/>
        </div>
    </div>
  </q-page>
</template>
...
export default {
  ...
  methods: {
    getInfo () {
      var _this = this
      configServices.loadData(this, '/subseccion-socios/104/json', {
        callBack: (data) => {
          _this.info = data
